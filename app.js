// ============================================
// MUNDIAL RETO - VERSIÓN DEFINITIVA
...
// ============================================
// BASE DE DATOS COMPLETA DEL MUNDIAL 2026
// ============================================
...
// ============================================
// FUNCIÓN QUE OBTIENE SOLO LOS PARTIDOS DEL DÍA
// ============================================
...
function obtenerPartidosDelDia() {
    ...
    // También mostrar partidos anteriores que el usuario no predijo aún
...
document.getElementById('confirmarExacto').onclick = async () => {
    ...
    webApp.showAlert(`✅ +${puntosGanados} puntos por tu predicción!`);
...
async function loadRanking() {
    ...
    if (!data) {
        container.innerHTML = '<div class="loading">Sin datos aún. ¡Sé el primero!</div>';
        return;
    }
...
function shareInvite() {
    webApp.openTelegramLink(`https://t.me/share/url?url=🏆 Mundial Reto&text=¡Predice los partidos del mundial y gana puntos! https://t.me/MundialRetoBot`);
    userPoints += 2;
    saveUserData();
    updateUI();
...
function watchAd() {
    ...
    saveUserData();
    updateUI();
    webApp.showAlert("🎬 +0.5 puntos por ver el anuncio!");
}
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    console.log("✅ Mundial Reto funcionando con todos los partidos del mundial");
});