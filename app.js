...
// Comodines, logros y ranking semanal funcionando
// ============================================
...
function verificarLogros() {
    ...
    // Logro: 5 amigos invitados (cuando se implemente)
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.querySelectorAll('.tab-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            // Mostrar/ocultar listas de ranking según filtro
            if (tabId === 'ranking') {
