// ============================================
// MUNDIAL RETO - VERSIÓN FINAL
// Con horarios de Cuba y puntos semanales persistentes
// ============================================
...
// ============================================
// Cuba GMT-4 (verano) / ET=GMT-4(misma) / CT=GMT-5(+1) / PT=GMT-7(+3) / MT=GMT-6(+2)
...
// ============================================
// BASE DE DATOS DE PARTIDOS (con hora original USA)
// ============================================
...
function obtenerPartidosDelDia() {
    ...
    // Solo partidos de hoy (NO anteriores)
...
document.getElementById('confirmarExacto').onclick = async () => {
    ...
    if (powerups.double > 0) {
        multiplicador = 2;
        powerups.double--;
        webApp.showAlert(`🔮 ¡COMODÍN ACTIVADO! Puntos duplicados: +${puntosGanados * multiplicador}`);
    }
...
async function loadUserData() {
    ...
    if (data) {
        ...
        // Cargar puntos de la semana correctamente
